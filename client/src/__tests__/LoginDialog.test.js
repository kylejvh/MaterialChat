// add jest config - look at docs for testing multiple configs
// in parallel using projects property - to include front end/back end tests together
...
// test cases
// a user logins in
// user login fails - axios mock promise.reject
